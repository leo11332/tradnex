/**
 * iOS home screen — full implementation.
 * IMPORTANT: Must NOT re-export from index.tsx (circular import on iOS via Metro).
 */
...
import { SkeletonLine, SkeletonMetricCard } from "@/components/SkeletonLoader";
